...
:build
cmd /c %csc% /reference:%gac%\%adb%\%ver1%\%adb%.dll /reference:%gac%\%ans%\%ver1%\%ans%.dll /reference:%gac%\%asi%\%ver1%\%asi%.dll /reference:%gac%\%acm%\%ver1%\%acm%.dll /reference:%gac%\%ars%\%ver1%\%ars%.dll /out:SWDExecTrending.exe *.cs
